...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4 py-12 relative">
      ...
      <div className="w-full max-w-md bg-card/60 border border-border rounded-2xl p-6 sm:p-8 shadow-xl backdrop-blur-sm">
        {success ? (
          ...
          <div>
            <div className="mb-6 text-center">
              ...
              <h2 className="text-2xl font-black text-foreground">Verify your identity</h2>
          ...
          <div>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          className="h-11 bg-secondary/40 border-border focus:border-primary/60 rounded-xl"
                          {...field}
                      ...
                      <div className="relative">
                        <FormControl>
                          <Input
                            ...
                            placeholder="••••••••"
                            className="h-11 bg-secondary/40 border-border focus:border-primary/60 rounded-xl pr-12"
                            {...field}
                ...
                <Button
                  type="submit"
                  className="w-full h-11 font-bold rounded-xl text-base mt-2"
                  disabled={isPending}
